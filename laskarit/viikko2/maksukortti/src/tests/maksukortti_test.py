...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_maukkaasti_ei_vie_saldoa_negatiiviseksi(self): #task 3
        kortti = Maksukortti(200)
    ...
    def test_negatiivisen_summan_lataaminen_ei_muuta_saldoa(self): #task 3
    ...
    def test_voi_ostaa_edullisen_lounaan_kun_lounaan_verran_kortilla(self): #task 3
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(kortti.saldo_euroina(), 0)

    def test_voi_ostaa_maukkaan_lounaan_kun_lounaan_verran_kortilla(self): #task 3
